...
public class ElevatorDoorInView extends RelativeLayout {
    ...
    public ElevatorDoorInView(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.door_in, this, true);
