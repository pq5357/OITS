    ...
    public AlertPopupWindow(Context context) {
        ...
        contentView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                int height = contentView.findViewById(R.id.ll_panel).getTop();
                int left = contentView.findViewById(R.id.ll_panel).getLeft();
                int right = contentView.findViewById(R.id.ll_panel).getRight();
                int bottom = contentView.findViewById(R.id.ll_panel).getBottom();
                int y=(int) event.getRawY();
                int x=(int) event.getRawX();
                Log.i("AlertPopupWindow", y +"+++"+x+"+++"+height + "+++"+ bottom + "+++" +
                        left + "+++" + right);
